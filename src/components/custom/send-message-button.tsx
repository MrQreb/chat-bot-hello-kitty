    ...
    return (
        <div className="w-full bg-message-container h-22 rounded-md mt-auto grid grid-cols-[90%_10%]">
            <Textarea
                ...
                className="!text-base xl:!text-lg placeholder:font-extrabold text-black font-semibold border-black resize-none focus:shadow-none focus-visible:ring-0 focus-visible:border-black border-none"
            />
            <Button
